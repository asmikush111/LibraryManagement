	...
	private JPanel contentPane;
        ...
        public aboutUs() {
           ...
           /* JLabel l1 = new JLabel("New label");
            ...
            JLabel l7 = new JLabel("Ayush Kumar Mishra, Ankit Kumar Maurya");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("Sachin Chaudhary , Shivangi Sharma");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l8.setBounds(70, 290, 600, 34);
            contentPane.add(l8);

            JLabel l9 = new JLabel("Lalita , Asmita Kushwaha ");
            l9.setFont(new Font("Trebuchet MS", Font.BOLD , 20));
            l9.setBounds(70, 320, 600, 34);
            contentPane.add(l9);


            JLabel l10 = new JLabel(" Btech CSE 2023 IET LUCKNOW");
